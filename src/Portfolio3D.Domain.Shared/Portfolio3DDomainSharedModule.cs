...
public class Portfolio3DDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        Portfolio3DGlobalFeatureConfigurator.Configure();
        Portfolio3DModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<Portfolio3DDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<Portfolio3DResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Portfolio3D");

            options.DefaultResourceType = typeof(Portfolio3DResource);
        ...
        {
            options.MapCodeNamespace("Portfolio3D", typeof(Portfolio3DResource));
        });
    }
}
